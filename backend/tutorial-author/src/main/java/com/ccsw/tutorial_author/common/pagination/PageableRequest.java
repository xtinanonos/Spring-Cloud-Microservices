...
public class PageableRequest implements Serializable {
    ...
    private List<SortRequest> sort;     // lista de objetos ordenados
    ...
    public static class SortRequest implements Serializable {
        ...
        private String property;        // nombre del campo por el que se desea ordenar

        private Sort.Direction direction;       // Sort.Direction es una enum con valores como asc o desc
